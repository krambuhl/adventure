...
const vs = `
  ...
  void main() {
    ...
    positionVec4.x += distortion * ((xAbs + 1.) / 2.01) * aNormal.x * amplitude;
    positionVec4.y += (distortion * ((yAbs * 1.4) / 1.3)) * aNormal.y * amplitude;
    positionVec4.z += (distortion * ((xAbs * yAbs * 1.2) / 10.3));
