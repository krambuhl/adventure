      ...
      <Grid
        ...
        getCellStyle={({ x, y }) => {
          ...
          const res = (
            ...
            (
              flag1
                ? Math.sin(x1 * slowestFrame) * Math.cos(y1 * slowestFrame) * slowestFrame
                : Math.sin(x1 * slowestFrame) * Math.cos(y1 * slowestFrame) * slowestFrame2
            ) +
...
OutputContainer.date = '2020-11-26'
